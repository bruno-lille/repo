...
def get_style():
    ...
    <script>
    function setTMDB(id) {
        document.getElementById("tmdb_input").value = id;
...
def home():
    ...
    titres, liens, col_A, col_C, tmdb_ids, jaquettes, annees, genres, resumes, casting, disc_ids = load_data_cached()
...
def suggest_update(disc_id):
    ...
    <div class="card">
        ...
        <form action="/manual_update/{disc_id}?q={query_encoded}" method="post">
            ...
            <input id="title" name="title" value="{title}" placeholder="Titre">
            ...
            <input id="tmdb_input" name="tmdb_input" placeholder="ID ou lien TMDB">
    ...
    for film in results_tmdb:
        ...
        <div class="card">
            ...
            <div class="btn-row">
                <button class="btn update" onclick="setTMDB('{film['id']}')">
                    🔗 Pré-remplir lien
                </button>

                <button class="btn allocine" onclick="setTitle(`{film['title']}`)">
                    📝 Pré-remplir titre
                </button>
            </div>
                   </div>
...
def prefill(disc_id, tmdb_id):
    ...
    <div class="card">
        <form action="/manual_update/{disc_id}" method="post">
            ...
            <input name="allocine" placeholder="🔗 Allociné"><br><br>

            <input name="tmdb_input" value="{tmdb_id}"><br><br>

    ...
    if results:
        ...
        for score, i in results:
            ...
            <div class="card">
                ...
                <div style="color:#aaa; font-size:14px; margin-top:5px; letter-spacing:0.5px;">
                ...
                <div style="color:#b0b0b0; font-size:15.5px; margin-top:6px; font-weight:500;">
    ...
    for film in results_tmdb:
        ...
        <div class="card">
            ...
            <form method="post" action="/manual_add">
                <input name="title" placeholder="Titre du film" value="{query}" required><br><br>

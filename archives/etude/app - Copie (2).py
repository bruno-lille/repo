...
def home():
    ...
    tmdb_search = f"https://www.themoviedb.org/search?query={query_encoded}"
    ...
    <div class="card">
        ...
        <a href="{tmdb_search}" target="_blank">
            <img src="https://via.placeholder.com/300x450?text={query_encoded}">
        </a>
        ...
        <div class="btn-row">
            ...
            <a class="btn new" href="/">🔄 Nouvelle recherche</a>
        </div>
